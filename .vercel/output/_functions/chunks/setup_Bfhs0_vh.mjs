import { A as AstroError, an as EnvInvalidVariables } from './astro/server_3QCLOVPR.mjs';
...
export { setup as a, createInvalidVariablesError as c, getEnv as g, setOnSetGetEnv as s };
